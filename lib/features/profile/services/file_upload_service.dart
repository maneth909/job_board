...
final fileUploadServiceProvider = Provider((ref) => FileUploadService(supabase));
...
class FileUploadService {
  ...
  Future<String?> uploadCv(File pdfFile, String originalFilename) async {
    ...
    await _supabase.storage.from('cvs').upload(
          filePath,
          pdfFile,
    ...
    await _supabase.from('jobseeker_profiles').update({
      'cv_url': publicUrl,
